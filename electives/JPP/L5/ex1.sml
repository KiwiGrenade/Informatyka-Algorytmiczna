...
fun main () =
    let
        val _ = print (Int.toString (binomial 8 4) ^ "\n")
        val _ = print (IntInf.toString (binomial2 8 4) ^ "\n")
        val _ = print (listToString (mergesort [10, 22, 18, 12091, 2, 3, 4, 2, 1, 3]) ^ "\n")
        val _ = print (case (de 20 25 5) of (x, y, z) => "(" ^ Int.toString x ^ ", " ^ Int.toString y ^ ", " ^ Int.toString z ^ ")\n")
        val _ = print (listToString (primeFactors 100) ^ "\n")
        val _ = print (Int.toString (totient 50) ^ "\n")
        val _ = print (Int.toString (totient2 50) ^ "\n")
        val _ = print (listToString (primes 50))
    in
        ()
    end
