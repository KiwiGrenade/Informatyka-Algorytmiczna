...
#  runs the p2p solver on local instances in the Square-n family

#  Usage: > perl runSquare-n.loc.p2p.pl
# ============================================================================
...
$RESFILE   = "../results/Square-n.loc.p2p.res";
$PREFIX    = "../inputs/Square-n/Square-n";
...
print   "* Square-n family local p2p core experiment\n";
