...
#  Last changed:   $Date: 2005/11/27 10:45:06 $
...
#  runs the p2p solver on local instances in the Long-n family

#  Usage: > perl runLong-n.loc.p2p.pl
# ============================================================================
...
$RESFILE   = "../results/Long-n.loc.p2p.res";
...
print   "* Long-n family local p2p core experiment\n";
