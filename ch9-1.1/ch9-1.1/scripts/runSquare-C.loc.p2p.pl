...
#  runs the p2p solver on local instances in the Square-C family

#  Usage: > perl runSquare-C.loc.p2p.pl
# ============================================================================
...
$RESFILE   = "../results/Square-C.loc.p2p.res";
...
print   "* Square-C family local p2p core experiment\n";
