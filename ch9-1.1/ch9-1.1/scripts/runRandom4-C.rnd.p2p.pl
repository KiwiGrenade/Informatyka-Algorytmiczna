...
#  runs the p2p solver on instances in the Random4-C family

#  Usage: > perl runRandom4-C.rnd.p2p.pl
# ============================================================================
...
$RESFILE   = "../results/Random4-C.rnd.p2p.res";
...
print   "* Random4-C family p2p core experiment\n";
