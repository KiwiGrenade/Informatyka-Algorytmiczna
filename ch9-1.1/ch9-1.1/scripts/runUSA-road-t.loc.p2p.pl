...
#  runs the p2p solver on instances in the USA-road-t family

#  Usage: > perl runUSA-road-t.loc.p2p.pl
# ============================================================================

# param setup:
$RESFILE   = "../results/USA-road-t.loc.p2p.res";
...
print   "* USA-road-t family loc p2p core experiment\n";
