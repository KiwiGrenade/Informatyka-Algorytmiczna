...
#  runs the p2p solver on local instances in the Random4-C family

#  Usage: > perl runRandom4-C.loc.p2p.pl
# ============================================================================
...
$RESFILE   = "../results/Random4-C.loc.p2p.res";
$PREFIX    = "../inputs/Random4-C/Random4-C";
...
print   "* Random4-C family local p2p core experiment\n";
