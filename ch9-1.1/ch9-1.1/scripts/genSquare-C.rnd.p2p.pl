...
#  Usage: > perl genSquare-C.rnd.p2p.pl
# ============================================================================
...
for ( $p = $START; $p < $END + 1 ; $p++ ) { 
    ...
    print "\n>> Generating p2p instances for data point [$str, C = 4^$p = $C]\n";
    ...
    for ( $trial = 0; $trial < $TRIALS; ++$trial) {
        ...
        print FILE "c Square-C family p2p problem aux file\n";
        print FILE "c\n";
