...
#  Random point-to-point query generator for the Random4-n family
#  Creates a suite of point-to-point shortest path
#  problem-specific auxiliary files.

#  Usage: > perl genRandom4-n.rnd.p2p.pl
# ============================================================================
...
$FORMAT   = "$DIR/Random4-n.%s.%s.p2p";


# header:
print "\n* 9th DIMACS Implementation Challenge: Shortest Paths\n";
print   "* http://www.dis.uniroma1.it/~challenge9\n";
print   "* Random query generator for the Random4-n family\n";
...
for ( $p = $START; $p < $END + 1 ; $p++ ) { 
    ...
    $n = (1<<$p);
    print "\n>> Generating p2p instances for data point [n=2^$p=$n]\n";
    ...
    for ( $trial = 0; $trial < $TRIALS; ++$trial) {
        ...
        print FILE "c Random4-n family p2p problem aux file\n";
        print FILE "c\n";
