...
#  runs the p2p solver on instances in the Long-C family

#  Usage: > perl runLong-C.rnd.p2p.pl
# ============================================================================
...
$RESFILE   = "../results/Long-C.rnd.p2p.res";
...
print   "* Long-C family p2p core experiment\n";
