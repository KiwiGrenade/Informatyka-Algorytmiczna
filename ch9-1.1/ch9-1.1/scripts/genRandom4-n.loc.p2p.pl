...
#  Usage: > perl genRandom4-n.loc.p2p.pl
# ============================================================================
...
$FORMAT   = "$DIR/Random4-n.%s.%s";

# header:
print "\n* 9th DIMACS Implementation Challenge: Shortest Paths\n";
print   "* http://www.dis.uniroma1.it/~challenge9\n";
print   "* Local query generator for the Random4-n family\n";
...
$n = (1<<$NEXP);
print "\n>> Generating local p2p instances for data point [n=2^$NEXP=$n]\n";
