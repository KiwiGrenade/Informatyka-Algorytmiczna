...
#  runs the p2p solver on instances in the Random4-n family

#  Usage: > perl runRandom4-n.rnd.p2p.pl
# ============================================================================
...
$RESFILE   = "../results/Random4-n.rnd.p2p.res";
...
print   "* Random4-n family p2p core experiment\n";
