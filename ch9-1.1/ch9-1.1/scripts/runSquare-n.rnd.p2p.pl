...
#  runs the p2p solver on instances in the Square-n family

#  Usage: > perl runSquare-n.rnd.p2p.pl
# ============================================================================
...
$RESFILE   = "../results/Square-n.rnd.p2p.res";
...
print   "* Square-n family p2p core experiment\n";
