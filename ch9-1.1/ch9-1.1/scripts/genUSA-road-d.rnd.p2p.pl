...
#  Random point-to-point query generator for the USA-road-d family
#  Creates a suite of point-to-point shortest path
#  problem-specific auxiliary files.

#  Usage: > perl genUSA-road-d.rnd.p2p.pl
# ============================================================================
...
$GRAPHF = "$DIR/USA-road-d.%s.gr";
$FORMAT = "$DIR/USA-road-d.%s.p2p";


# header:
print "\n* 9th DIMACS Implementation Challenge: Shortest Paths\n";
print   "* http://www.dis.uniroma1.it/~challenge9\n";
print   "* Random query generator for the USA-road-d family\n";
...
sub DOGEN { 
    ...
    print FILE "c USA-road-d family p2p problem aux file\n";
    print FILE "c\n";
