...
TEST_NAME_LIST=("test1.cpp" "test2.cpp" "test1D.cpp" "test2D.cpp")
TEST_RESULT_LIST=()
...
do
	...
	if [[ $TEST_NAME == *D* ]]
	then
		(./ex3 -d < $INPUT_DIR/$TEST_NAME) > $OUTPUT_DIR/$OUTPUT_NAME
	else
		(./ex3 < $INPUT_DIR/$TEST_NAME) > $OUTPUT_DIR/$OUTPUT_NAME
	fi
